...
const selectTv = tv({
  slots: {
    ...
    input:
      'mt-0 flex-row items-center justify-center border-[0.5px] border-grey-300 px-3 py-3  rounded-xl dark:bg-neutral-800 dark:border-neutral-500',
    inputValue: 'dark:text-neutral-200',
  },
